  ...
  \resumeSubHeadingListStart
   \resumeSubheading
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
       \resumeItem{Implemented a big data system using Python and SQL that could track which were the most viewed, purchased and add to cart products from an advertiser's website. Return-on-ad-spent metric was incremented by 20\% for clients that used the algorithm}
        ...
        \resumeItem{Worked with 5+ Facebook advertisers to reach their business objectives. Impacted on 100K+ dollars in advertising spending for Meta}
      \resumeItemListEnd
...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Followed the course "Intro to Neural Networks" by Andrej Karpathy to make a neural network that takes drum tabs in JSON format as input and outputs more rhythms similar to the initial using gradient descent.}
          \resumeItemListEnd
      \resumeProjectHeading
